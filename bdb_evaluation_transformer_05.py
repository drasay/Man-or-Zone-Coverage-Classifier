...
def process_and_visualize(week_number):
    ...
    pred_file = f"C:/python/nfl-big-data-bowl-2025/week_{week_number}_preds_transformer.csv"
...
if __name__ == "__main__":
    pred_file = f"C:/python/nfl-big-data-bowl-2025/week_1_preds_transformer.csv"
