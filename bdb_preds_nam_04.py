...
import pandas as pd
import joblib
from bdb_training_nam_03 import ManZoneNAM
...
# Load Model
best_params = joblib.load(f"C:/python/nfl-big-data-bowl-2025/optim_results_nam/man_zone_nam_week{week_eval}_study.pkl").best_trial.params
...
model.load_state_dict(torch.load(f"C:/python/nfl-big-data-bowl-2025/best_model_week{week_eval}_nam.pth", weights_only=True))
model.eval()
...
df_results.to_csv(f"C:/python/nfl-big-data-bowl-2025/week_{week_eval}_preds_nam.csv", index=False)
